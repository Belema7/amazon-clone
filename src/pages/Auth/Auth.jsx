    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-8 px-4">
      <section className="w-full max-w-sm bg-white rounded-lg shadow-sm border border-gray-300 p-6">
        ...
        <div className="relative flex items-center my-6">
          ...
          <span className="flex-shrink mx-4 text-xs text-gray-500 bg-white px-2">New to Amazon?</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>

        {/* create an account */}
        <Link to="/register">
          <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900 font-medium py-2 rounded-md border border-gray-300 shadow-sm transition-all duration-200 hover:shadow-md">

    ...
    <>
      ...
      <header className="bg-[#FF6200] text-white">
        ...
        <div className="bg-[#FF9946] px-3 py-2 flex items-center space-x-6 text-sm">
          ...
          <NavLink to="/deals" className="hover:border border-white px-2 py-1 rounded-sm hidden md:block transition-all">
            Today's Deals
          </NavLink>
          
          <NavLink to="/help" className="hover:border border-white px-2 py-1 rounded-sm hidden md:block transition-all">
            Customer Service
          </NavLink>
          
          <NavLink to="/registry" className="hover:border border-white px-2 py-1 rounded-sm hidden lg:block transition-all">
            Registry
          </NavLink>
          
          <NavLink to="/gift-cards" className="hover:border border-white px-2 py-1 rounded-sm hidden lg:block transition-all">
            Gift Cards
          </NavLink>
          
          <NavLink to="/sell" className="hover:border border-white px-2 py-1 rounded-sm hidden xl:block transition-all">
            Sell
          </NavLink>
        </div>
      </header>
